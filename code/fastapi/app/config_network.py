# config_network.py
# Supplementary script for gantry robot of the digital twin testbed described in:
...
AGENTS_ADRESSES = {
    "Gantry-Crane": "http://localhost:8000/JSONrequest",
    #"Worker-1": "http://255.255.255.255:8000",
    #"Worker-2": "http://255.255.255.255:8000"
}